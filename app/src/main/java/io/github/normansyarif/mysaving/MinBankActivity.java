...
public class MinBankActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_min_bank);
    ...
    private void setData() {
        Cursor res = myDb.getFromDb("col_bank");
        if(res.getCount() != 0) {
    ...
    public void saveData(View v) {
        boolean isUpdate = myDb.updateData("col_bank", Utils.moneyToNumber(tvMoney.getText().toString()));
        if(isUpdate)
            finish();
        else
            Toast.makeText(MinBankActivity.this,"Nothing changed.",Toast.LENGTH_LONG).show();
    }
